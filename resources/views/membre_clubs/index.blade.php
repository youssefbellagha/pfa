...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Membre Clubs</h4>
            </div>
        ...
        @if(count($membreClubs) == 0)
            <div class="panel-body text-center">
                <h4>No Membre Clubs Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($membreClubs as $membreClub)
                        <tr>
                            <td>{{ optional($membreClub->etudiant)->name }}</td>
                            <td>{{ optional($membreClub->club)->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('membre_clubs.membre_club.show', $membreClub->id ) }}" class="btn btn-info" title="Show Membre Club">
